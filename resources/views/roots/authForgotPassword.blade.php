...
>
  <head>
    ...
    <!-- Page CSS -->
    <!-- Page -->
    <link rel="stylesheet" href="{{asset('roots/assets/vendor/css/pages/page-auth.css')}}" />
    <!-- Helpers -->
               ...
               <div class="app-brand justify-content-center">
                <a href="index.html" class="app-brand-link gap-2">
                  <span class="app-brand-logo demo">
                   <img src="{{asset('users/img/logo.png')}}" style="width:200px; height:200px;"/>
                  </span>
                 
                </a>
              </div>
              <h4 class="mb-2">Mot de passe oublié? 🔒</h4>
              <p class="mb-4">Entrez votre email, vous recevrez des instructions pour réinitialiser votre mot de passe..</p>
