            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="section-title">
                        ...
                        <p>Ne ratez rien A propos de cet évènement 40 {{sizeof($calendars)}}</p>
                    </div>
                </div>
            </div>
            <div class="row">
                                ...
                                <div class="st-content">
                                    <div class="container">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-5">
                                                <div class="sc-text">
                                                    <h4>{{$calendar->subtitle}}</h4>
                                                    <ul>
                                                        <li><i class="fa fa-user"></i> {{$activity->activity}}</li>
                                            ...
                                            <div class="col-lg-4">
                                                <ul class="sc-widget">
                                                    <li><i class="fa fa-clock-o"></i>{{$activity->time}}</li>
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="cs-map">
                        ...
                        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3967.016637614531!2d1.212522075248455!3d6.128462993858326!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x1023e1dfa99fad07%3A0x2e40858c4d8f3887!2zSMO0dGVsIDIgRsOpdnJpZXIgTG9tw6k!5e0!3m2!1sfr!2stg!4v1693176313853!5m2!1sfr!2stg"
