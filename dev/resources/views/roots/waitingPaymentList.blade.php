...
@section('title')
    Validation paiement  | Administration NDD
@endsection
@section('content')
@section('content')
    <!-- Content wrapper -->
    ...
    <div class="content-wrapper">
        ...
        <div class="container-xxl flex-grow-1 container-p-y">
            <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Pages /</span> Liste des Paiements en Attente de Validation </h4>
                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="d-flex align-items-center">
                                <h4 class="card-title">Paiements en Attente de Validation</h4>
                            </div>
                        </div>
                        <div class="card-body">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <div class="form-button-action">
                                                    <a data-bs-toggle="tooltip modal" title="Vérifier" class="btn btn-icon btn-info btn-sm" data-original-title="Vérifier" href="{{url('ndd-admin/checkPayment', $attendee->slug)}}">
