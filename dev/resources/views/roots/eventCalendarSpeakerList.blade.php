...
@section('title')
Panélistes de chaque évènement - Listes  | Administration NDD
@endsection
@section('content')
<!-- Content wrapper -->
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Pages /</span> Liste des panélistes du programme du  {{$calendar->day}}</h4>
